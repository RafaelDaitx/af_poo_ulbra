...
public class StocksHttp {
    ...
    public static ArrayList<Stocks> loadCurrencies(){
        try {
    ...
    public  static ArrayList<Stocks> readJsonStocks(JSONObject json){
        ...
        try {
            ...
            JSONObject ibo=jsonStocks.getJSONObject("IBOVESPA");
            JSONObject nas=jsonStocks.getJSONObject("NASDAQ");
            JSONObject cac=jsonStocks.getJSONObject("CAC");
            JSONObject nik=jsonStocks.getJSONObject("NIKKEI");
            array.add(getStocksFromJson(ibo));
            array.add(getStocksFromJson(nas));
            array.add(getStocksFromJson(cac));
            array.add(getStocksFromJson(nik));
    ...
    public static Stocks getStocksFromJson(JSONObject json) {
        ...
        try {
            ...
            coin = new Stocks(name, location, variation);
        } catch (JSONException e) {
